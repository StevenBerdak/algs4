...
public class DepthFirstOrder {
    ...
    // getResults DFS in digraph G from vertex v and compute preorder/postorder
    ...
    // getResults DFS in edge-weighted digraph G from vertex v and compute preorder/postorder
